    ...
    UEDITOR_CONFIG = {
        ...
        toolbars:[
            ['FullScreen', 'Source', '|', 'Undo', 'Redo', '|',
                ...
                'Link', 'Unlink', 'Anchor', '|', 'ImageNone', 'ImageLeft', 'ImageRight', 'ImageCenter', '|', 'InsertImage', 'InsertVideo', 'Map', 'GMap', 'InsertFrame', 'PageBreak', 'HighlightCode', '|',
...
//                  ],
        ...
        listMap:{
            //字体
            'fontfamily':['微软雅黑', '宋体', '楷体', '隶书', '黑体', 'andale mono', 'arial', 'arial black', 'comic sans ms', 'impact', 'times new roman'],
            //字号
        ...
        'body{margin:8px;font-family:"微软雅黑";font-size:16px;}' +
        ...
        pageBreakTag:'_mimo_page_break_tag_', //分页符
