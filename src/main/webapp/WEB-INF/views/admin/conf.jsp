...
<div class="nlft">
<ul class="wcc">
<h1><strong>站点管理</strong></h1>
<shiro:hasPermission name="home-conf:edit">
<li><a href="${ctx}/home-conf/edit/" target="right"><span class="allIco ico15"></span>首页配置</a></li>
</shiro:hasPermission>
...
<li><a href="${ctx}/channel/create/" target="right"><span class="allIco ico15"></span>创建栏目</a></li>
</shiro:hasPermission>
