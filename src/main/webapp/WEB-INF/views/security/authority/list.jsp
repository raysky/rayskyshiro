...
<div class="chsm"><span>用户权限管理</span></div>
<div class="czsrt">
<span>你可以：</span>
...
<div class="rcd_td">
  ...
  <c:choose>
  	...
  	<tr>
    <td style="border-left:0;"><input type="checkbox" name="items" id="checkbox" value="${authority.id}"/></td>
    <td>${authority.name}&nbsp;</td>
    <td>${authority.permission }&nbsp;</td>
    <td>
    	<shiro:hasRole name="admin">
		<a href="${ctx }/security/authority/${authority.id}/edit/" >编辑</a>
    	</shiro:hasRole>
		&nbsp;
    </td>
  	</tr>
