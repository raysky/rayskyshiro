...
<div class="chsm"><span>用户管理</span></div>
<div class="czsrt">
<span>你可以：</span>
...
<span class="dist">名称：</span><input name="params" value="${page.params }" type="text" /><input class="tjbtn" type="submit" value="提交" />
</div>
<p>${message.text }</p>
<div class="rcd_td">
  ...
  <c:choose>
  	...
  	<tr>
    <td style="border-left:0;"><input type="checkbox" name="items" id="checkbox" value="${user.id}"/></td>
    <td>${user.username}&nbsp;</td>
